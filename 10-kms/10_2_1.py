...
# encrypt file
encrypt_file('./date_file.txt', 'b0bcc782-97fb-4f83-8ebd-34154ce11386')

# write file
s3 = boto3.resource('s3')
s3.Bucket('nb-stelligent-u').upload_file('date_file.txt.encrypted','date_file.txt.encrypted')

# output file
object_key = "date_file.txt.encrypted"
file_content = s3.client.get_object(Bucket='nb-stelligent-u', Key=object_key)["Body"].read()
print(file_content)
...
# decrypt file
decrypt_file('date_file.txt.encrypted')